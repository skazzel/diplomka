...
import cz.vutbr.fit.hospitu.data.response.impl.medical.MedicalResponse;
...
public class medicationController {
    ...
    public static void getMedication(Context context) {
        ...
        try (Connection connection = SQLConnection.create()) {
            String sql = """
                SELECT medication_id, name FROM medications WHERE name LIKE ?
            """;
