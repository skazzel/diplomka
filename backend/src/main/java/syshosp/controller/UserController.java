...
import syshosp.controller.validator.BasicValidator;
import syshosp.controller.validator.UserValidator;
import syshosp.data.request.ProfileUpdateRequestData;
import syshosp.data.response.generic.Generic403ResponseData;
import syshosp.data.response.generic.Generic404ResponseData;
import syshosp.data.response.impl.ExtendedUserResponseData;
import syshosp.data.response.impl.ProfileUpdateResponseData;
import syshosp.data.response.impl.UserResponseData;
