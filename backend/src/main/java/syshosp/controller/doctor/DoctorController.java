package syshosp.controller.doctor;

import syshosp.data.request.doctor.NewPatientRequestData;
import syshosp.data.request.doctor.UnPatientRequestData;
import syshosp.data.response.impl.doctor.DoctorListResponseData;
import syshosp.data.response.impl.doctor.DoctorResponseData;
import syshosp.data.response.impl.doctor.HumanReadableResponseData;
import syshosp.data.response.impl.doctor.NewPatientUpdateResponseData;
import syshosp.data.response.impl.doctor.PractitionersListResponseData;
import syshosp.data.response.impl.doctor.PractitionersResponseData;
import syshosp.data.response.impl.doctor.UnPatientsListResponseData;
import syshosp.data.response.impl.doctor.UnPatientsResponseData;
import syshosp.data.response.impl.doctor.UnPatientsUpdateResponseData;
