...
import syshosp.data.response.impl.doctor.FileListResponseData;
import syshosp.data.response.impl.doctor.FileResponseData;
import syshosp.data.response.impl.doctor.FileUpdateResponseData;
import syshosp.data.response.impl.doctor.HumanReadableResponseData;
import syshosp.data.request.doctor.FileRequestData;
