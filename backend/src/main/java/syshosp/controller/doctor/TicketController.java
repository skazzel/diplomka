...
import syshosp.data.response.impl.doctor.TicketListResponseData;
import syshosp.data.response.impl.doctor.TicketResponseData;
import syshosp.data.response.impl.doctor.TicketUpdateResponseData;
import syshosp.data.request.doctor.TicketRequestData;
